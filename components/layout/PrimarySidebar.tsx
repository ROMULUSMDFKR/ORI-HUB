  ...
  return (
    <div className="w-20 bg-indigo-950 flex-shrink-0 flex flex-col items-center py-4 relative z-50">
      <Link to="/" className="mb-6 flex-shrink-0">
        <img src="https://firebasestorage.googleapis.com/v0/b/ori-405da.firebasestorage.app/o/Logo%2FLOGO%20BLANCO.png?alt=media&token=88ceaa56-56c5-4270-80b4-25c0b398da84" alt="ORI Logo" className="w-5 h-auto" />
      </Link>
