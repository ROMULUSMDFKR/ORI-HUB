        ...
        <div className="max-w-4xl mx-auto pb-20">
             <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-3">
                    <button onClick={() => navigate(`/tasks/${id}`)} disabled={isSaving} className="bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 text-slate-800 dark:text-slate-200 font-semibold py-2.5 px-5 rounded-xl shadow-sm hover:bg-slate-50 dark:hover:bg-slate-600 disabled:opacity-50 transition-colors">Cancelar</button>
             ...
             <div className="space-y-6">
                <FormCard title="Información básica" icon="info">
                    <div>
                        ...
                        <div className={inputWrapperClass}>
                            ...
                            <input type="text" value={task.title} onChange={e => handleFieldChange('title', e.target.value)} className={inputFieldClass} />
                        </div>
                    </div>
                     <div>
                ...
                <FormCard title="Fechas y estimación" icon="calendar_month">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <div className={inputWrapperClass}>
                                ...
                                <input type="date" value={task.startDate?.split('T')[0] || ''} onChange={e => handleFieldChange('startDate', e.target.value ? new Date(e.target.value).toISOString() : undefined)} className={inputFieldClass}/>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className={inputWrapperClass}>
                                ...
                                <input type="date" value={task.dueAt?.split('T')[0] || ''} onChange={e => handleFieldChange('dueAt', e.target.value ? new Date(e.target.value).toISOString() : undefined)} className={inputFieldClass}/>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className={inputWrapperClass}>
                                ...
                                <input type="number" value={task.estimationHours || ''} onChange={e => handleFieldChange('estimationHours', parseFloat(e.target.value) || 0)} className={inputFieldClass}/>
                            </div>
                        </div>
                    </div>
                </FormCard>
