                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                             ...
                             <input type="text" value={editedUser.phone || ''} onChange={e => handleFieldChange('phone', e.target.value)} className="mt-1 w-full" placeholder="+52..."/>
                        </div>
                        <div>
                             <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Extensión</label>
                             <input type="text" value={editedUser.extension || ''} onChange={e => handleFieldChange('extension', e.target.value)} className="mt-1 w-full" placeholder="201"/>
                        </div>
                    </div>
